...
#include "GEometryPractice/TP_PickUpComponent.h"
...
// Cross Module References
	...
	GEOMETRYPRACTICE_API UClass* Z_Construct_UClass_UTP_PickUpComponent_NoRegister();
	GEOMETRYPRACTICE_API UClass* Z_Construct_UClass_UTP_PickUpComponent();
	ENGINE_API UClass* Z_Construct_UClass_USphereComponent();
	ENGINE_API UClass* Z_Construct_UClass_UPrimitiveComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics
	{
		struct _Script_GEometryPractice_eventOnPickUp_Parms
		{
			AGEometryPracticeCharacter* PickUpCharacter;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter = { "PickUpCharacter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_GEometryPractice_eventOnPickUp_Parms, PickUpCharacter), Z_Construct_UClass_AGEometryPracticeCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::NewProp_PickUpCharacter,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_GEometryPractice, nullptr, "OnPickUp__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::_Script_GEometryPractice_eventOnPickUp_Parms), Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature_Statics::FuncParams);
		}
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp = { "OnPickUp", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTP_PickUpComponent, OnPickUp), Z_Construct_UDelegateFunction_GEometryPractice_OnPickUp__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp_MetaData)) }; // 851359497
	...
	template<> GEOMETRYPRACTICE_API UClass* StaticClass<UTP_PickUpComponent>()
	{
		return UTP_PickUpComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_PickUpComponent);
	struct Z_CompiledInDeferFile_FID_GEometryPractice_Source_GEometryPractice_TP_PickUpComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GEometryPractice_Source_GEometryPractice_TP_PickUpComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_PickUpComponent, UTP_PickUpComponent::StaticClass, TEXT("UTP_PickUpComponent"), &Z_Registration_Info_UClass_UTP_PickUpComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_PickUpComponent), 1410410933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GEometryPractice_Source_GEometryPractice_TP_PickUpComponent_h_30319904(TEXT("/Script/GEometryPractice"),
		Z_CompiledInDeferFile_FID_GEometryPractice_Source_GEometryPractice_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GEometryPractice_Source_GEometryPractice_TP_PickUpComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
